...
let tekiMaster  =
[
    new TekiMaster(0, 10, 1, 100),   //ピンクひよこ
    new TekiMaster(1, 10, 1, 100),   //黄色ひよこ
    new TekiMaster(2, 70, 1000, 10000), //ボスひよこ
    new TekiMaster(3, 10, 1, 100), //黄色ひよこ２
	new TekiMaster(4, 10, 2, 150), //青グラサン
	new TekiMaster(5, 15, 5, 150), //ロボット
	new TekiMaster(6, 70, 3000, 10000), //青グラサンボスひよこ
	new TekiMaster(7, 10, 1, 0), //卵
	new TekiMaster(8, 10, 1, 150), //ニワトリ
	new TekiMaster(9, 10, 5, 150), //脱帽ニワトリ
	new TekiMaster(10, 70, 5000, 10000), //ピンクのひよこ
]
...
//スプライト
let sprite = [
    new Sprite(0, 0, 22, 42),//0 左２
    new Sprite(23, 0, 33, 42),//1　左１
    new Sprite(57, 0, 43, 42),//2　正面
    new Sprite(101, 0, 33, 42),//3　右１
    new Sprite(135, 0, 21, 42),//4　右２

    new Sprite(0, 50, 3, 7),//5 たま１
    new Sprite(4, 50, 5, 5),//6 たま２
